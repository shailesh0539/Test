...
//		activityPage().navigateToLeftMenu("View Exports");
//		activityPage().verifyViewExportFile();
//		
//		Reporter.info("Verify user is redirect to buyer or vendor page");
//		activityPage().selectDropDown("Event Category", "QR Code Scan");
//		activityPage().setFromDate(-70);
//		activityPage().selectAndVerifyUser(1);
//	}
}
